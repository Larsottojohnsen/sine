  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const onPointerDown = (e: PointerEvent) => {
        ...
        uniforms.uClickPos.value[clickIx].set(fx, h - fy)
    ...
    antialias, liquid, pixelSize, patternScale, patternDensity, enableRipples,
    rippleIntensityScale, rippleThickness, rippleSpeed, pixelSizeJitter, edgeFade,
    transparent, liquidStrength, liquidRadius, liquidWobbleSpeed, autoPauseOffscreen,
    variant, color, speed,
  ])
