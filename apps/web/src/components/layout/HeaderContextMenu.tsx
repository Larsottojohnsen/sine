  ...
  return (
    <div
      ...
      style={{
        ...
        top,
        zIndex: 99999,
        background: 'var(--hmenu-bg, #38383a)',
        border: '1px solid var(--hmenu-border, rgba(255,255,255,0.1))',
        borderRadius: 14,
        boxShadow: '0 12px 40px rgba(0,0,0,0.5), 0 2px 8px rgba(0,0,0,0.3)',
        padding: '6px',
        width: menuW,
        '--hmenu-bg': 'var(--ctx-bg, #38383a)',
        '--hmenu-border': 'var(--ctx-border, rgba(255,255,255,0.1))',
        '--hmenu-text': 'var(--ctx-text, #D0D0D0)',
        '--hmenu-hover': 'var(--ctx-hover, rgba(255,255,255,0.07))',
